...
export default function CraftsmanshipSection() {
  ...
  return (
    <section id="craft" className="bg-[#F6F4EE] text-[#1A1A1A] py-24 px-8 md:px-16 lg:px-24 scroll-mt-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        {/* Left Column: Texture Image */}
        <ScrollReveal direction="left" className="lg:col-span-5">
          <div className="relative h-[520px] rounded-lg overflow-hidden shadow-sm">
            <Image
              src="/craft.png"
          ...
          <div className="divide-y divide-[#E2DED5]">
            {features.map((item, i) => (
              <ScrollReveal
                ...
                delay={0.15 * (i + 1)}
              >
                <div className="py-5 flex items-start space-x-6">
