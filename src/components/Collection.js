...
export default function CollectionGridSection() {
  return (
    <section
      id="collection"
      className="bg-[#171717] text-white py-24 px-8 md:px-16 lg:px-24 scroll-mt-20"
    >
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-6">
          ...
          <ScrollReveal direction="left" delay={0.1} className="lg:col-span-4">
            <div className="relative group overflow-hidden rounded-2xl h-[640px]">
              <Image
